...
$routes->delete('/delete/(:any)', 'MahasiswaController::delete/$1');
$routes->post('/update/(:any)', 'MahasiswaController::update/$1');
$routes->get('/edit/(:any)', 'MahasiswaController::edit/$1');
